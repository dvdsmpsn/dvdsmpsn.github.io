...
$(function() {
	...
	var syndicationTargetPageId = 'xxxxx-syndication-target-xxxxx-xxxx';
	var videoGuid = 'xxxx-video-guid-here-xxxx';
	...
	$('video').bind('loadedmetadata', function(){
		...
		dcsMultiTrack(
			...
			'DCSext.w_event_type','Duration: '+Math.round(this.duration*10)/10+'s'
		);
	});
